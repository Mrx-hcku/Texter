...
class _ChatListScreenState extends State<ChatListScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _load() async {
    ...
    if (user == null) return[span_0](start_span)[span_0](end_span);
    _myId = user.$id;
    try {
      final chats = await AppwriteService.instance.getChats(user.$id);[span_1](start_span)[span_1](end_span)
      setState(() {
        _chats = chats;
        _loading = false;
      });
                  ...
                  : filtered.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, i) {
                            ...
                            // Safe check for pinning & unread count (falls back gracefully if fields don't exist in backend yet)
                            ...
                            return Dismissible(
                              ...
                              confirmDismiss: (direction) async {
                                if (direction == DismissDirection.startToEnd) {
                                  // Archive Action (Swipe Left to Right)
                                  setState(() {
                                ...
                                child: ListTile(
                                  ...
                                  leading: Stack(
                                    children: [
                                      ...
                                      // Unread Blue Dot on Avatar (Telegram Style)
